    ...
    return (
      <form className="column player" onSubmit={this.handleSubmit}>
        ...
        <div className="row player-inputs">
          <input onChange={this.handleChange} value={this.state.username} type="text" id="username" className="input-light" placeholder="github username" autoComplete="off"></input>
