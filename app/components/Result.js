    ...
    return (
      <div className="grid space-around container-sm">
        <div className="card bg-light">
          ...
          <img alt={`Avatar for ${winner.profile.login}`} className="avatar" src={winner.profile.avatar_url} />
        ...
        <div className="card bg-light">
          ...
          <img alt={`Avatar for ${loser.profile.login}`} className="avatar" src={loser.profile.avatar_url} />
